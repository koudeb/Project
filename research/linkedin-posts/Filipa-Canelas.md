...
LinkedIn's VP of Marketing shared something about LLMs citing LinkedIn content that I'm taking immediate action on.

LinkedIn® is the no.1 most-cited domain for professional queries across major AI search engines. And SEMRush data shows what's getting cited:

→ Articles account for ~60% of LinkedIn citations
→ Posts account for ~40%

So yes, LLMs are sourcing content from LinkedIn... but not whatever went viral last week.

Instead, they pick credibility > virality. 

→ Subject matter experts with consistent, in-depth content
→ Posts with 10+ comments signal authority to AI models
→ Long-form articles that demonstrate real expertise
→ 95% of citations come from original posts 

This dropped last week. We've already come up with a plan to get every single MKTK client benefiting from this.

Your CEO's content is no longer just a social play. (never was)

It helps to determine whether they show up - or don't - when buyers ask AI to build their shortlist.
